        ...
        <div className="container">
            <div className="row p-5 mt-5 mb-5">
                ...
                <div className="col-4 mt-5">
                    <h1 className="fs-5 mb-5"><i className="fa fa-plus-circle" aria-hidden="true"></i> Account Opening</h1>
                ...
                <div className="col-4  mt-5">
                    <h1 className="fs-5 mb-5"><i className="fa fa-user" aria-hidden="true"></i> Account Opening</h1>
                ...
                <div className="col-4  mt-5">
                    <h1 className="fs-5 mb-5"><i className="fa fa-bar-chart" aria-hidden="true"></i> Account Opening</h1>
                    <a href="" style={{lineHeight:"2.5"}}>Margin/Leverage, Product and Order types</a><br/>
                    <a href="" style={{lineHeight:"2.5"}}>Kite Web and Mobile</a><br/>
                    <a href="" style={{lineHeight:"2.5"}}>Trading FAQs</a><br/>
                    <a href="" style={{lineHeight:"2.5"}}>Corporate Actions</a><br/>
                    <a href="" style={{lineHeight:"2.5"}}>Settlements</a><br/>
                    <a href="" style={{lineHeight:"2.5"}}>Kite API</a><br/>
                    <a href="" style={{lineHeight:"2.5"}}>Pi and other platform</a><br/>
                    <a href="" style={{lineHeight:"2.5"}}>Stockreports</a><br/>
                    <a href="" style={{lineHeight:"2.5"}}>GTT</a><br/>
                </div>
                <div className="col-4  mt-5">
                    <h1 className="fs-5 mb-5"><i className="fa fa-credit-card" aria-hidden="true"></i> Funds</h1>
                ...
                <div className="col-4 mt-5 ">
                    <h1 className="fs-5 mb-5"><i className="fa fa-circle-o-notch" aria-hidden="true"></i> Console</h1>
                    ...
                    <a href="" style={{lineHeight:"2.5"}}>60 Day Challenge</a><br/>
                    <a href="" style={{lineHeight:"2.5"}}>IPO</a><br/>
                    <a href="" style={{lineHeight:"2.5"}}>Referral Program</a><br/>
                </div>
                <div className="col-4 mt-5">
                    <h1 className="fs-5 mb-5"><i className="fa fa-circle-thin" aria-hidden="true"></i> Coin</h1>
                    ...
                    <a href="" style={{lineHeight:"2.5"}}>Government Securities</a><br/>
                </div>
            </div>
        </div>
    )
